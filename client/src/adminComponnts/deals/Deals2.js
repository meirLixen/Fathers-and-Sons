  ...
  return (
    <tr key={index}>
      ...
      <td className="px-6 py-4 whitespace-nowrap">
        ...
        <div className="text-sm text-gray-900">{element.pupilFullName}</div>
      </td>
      <td className="px-6 py-4 whitespace-nowrap">
      ...
      >
        {`${element.time.slice(0, 10).split("-")[2]}-${
          element.time.slice(0, 10).split("-")[1]
        }-${element.time.slice(0, 10).split("-")[0]} ${element.time.slice(
          11,
          16
        )}
